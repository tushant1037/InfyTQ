...
def calculate_loan(account_number,salary,account_balance,loan_type,loan_amount_expected,customer_emi_expected):
    ...
    typeofloan = ['Car','House','Business']
    
    accno = list(str(account_number))
    f = accno[0]
    if f!='1':
        print("Invalid account number")
    if account_balance<100000:
        print("Insufficient account balance")
    if loan_type not in typeofloan:
    ...
    if loan_type=="Car" and salary>25000 and f=='1' and account_balance>=100000:
        if loan_amount_expected<=500000 and customer_emi_expected<=36:
            prtfun(account_number,eligible_loan_amount,bank_emi_expected,loan_amount_expected,customer_emi_expected)
        else:
            print("The customer is not eligible for the loan")
    elif loan_type=="House" and salary>50000 and f=='1' and account_balance>=100000:
        if loan_amount_expected<=6000000 and customer_emi_expected<=60:
            prtfun(account_number,eligible_loan_amount,bank_emi_expected,loan_amount_expected,customer_emi_expected)
        else:
            print("The customer is not eligible for the loan")
    elif loan_type=="Business" and salary>75000 and f=='1' and account_balance>=100000:
...
def prtfun(account_number,eligible_loan_amount,bank_emi_expected,loan_amount_expected,customer_emi_expected):
